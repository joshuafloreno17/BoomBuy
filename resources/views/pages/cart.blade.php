...
@php
    ...
    $adminProducts = session()->get('admin_products', []);
    ...
    foreach ($adminProducts as $product) {
        ...
        if (!empty($product['slug'])) {
            ...
            $products[$product['slug']] = [
                ...
                'seller_name' => $product['seller_name'] ?? 'BoomBuy Official',
    ...
    */
    ...
    $databaseProducts = \App\Models\Product::all();
